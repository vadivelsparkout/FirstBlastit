...
declare namespace methods {
     ...
     * @this {import('../adb.js').ADB}
     */
    function endAndroidCoverage(this: import("../adb.js").ADB): Promise<void>;
    /**
     ...
     */
    function instrument(this: import("../adb.js").ADB, pkg: string, activity: string, instrumentWith: string): Promise<void>;
    /**
     ...
     *                   without errors.
     */
    function androidCoverage(this: import("../adb.js").ADB, instrumentClass: string, waitPkg: string, waitActivity: string): Promise<void>;
    /**
