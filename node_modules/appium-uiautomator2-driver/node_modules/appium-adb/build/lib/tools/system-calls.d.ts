...
declare namespace systemCallMethods {
     ...
     */
    function createSubProcess(this: import("../adb.js").ADB, args?: string[] | undefined): SubProcess;
    /**
     ...
     */
    function installMitmCertificate(this: import("../adb.js").ADB, cert: string | Buffer): Promise<void>;
    /**
     ...
     */
    function isMitmCertificateInstalled(this: import("../adb.js").ADB, cert: string | Buffer): Promise<boolean>;
}
